...
export default function ProductImages({ product }) {
  ...
  const addToFavourite = () => {
    ...
    openSnackbar({
      ...
      variant: 'alert',
      alert: {
        color: !wishlisted ? 'success' : 'error'
      }
    });
  };
...
ArrowUp.propTypes = { currentSlide: PropTypes.number, slideCount: PropTypes.number, props: PropTypes.any };

ArrowDown.propTypes = { currentSlide: PropTypes.number, slideCount: PropTypes.number, props: PropTypes.any };
