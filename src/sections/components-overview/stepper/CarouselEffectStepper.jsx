...
SampleNextArrow.propTypes = { className: PropTypes.string, style: PropTypes.any, onClick: PropTypes.func };

SamplePrevArrow.propTypes = { className: PropTypes.string, style: PropTypes.any, onClick: PropTypes.func };
